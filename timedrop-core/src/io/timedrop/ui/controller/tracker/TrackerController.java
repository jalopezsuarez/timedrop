...
{
	private static final long serialVersionUID = 3568206838223709415L;
	...
	public void initViewController(JFrame frame)
	{
		context = frame;
		...
		try
		{
			...
			response = sessionService.findInterruptionsToday();
		}
		catch (Exception ex)
		{
	...
	public void renderViewController()
	{
			...
			}
			{
				...
				panelTrackerSection.setLayout(new CardLayout());
				{
					...
					}
					{
						...
						layoutTrackerManager.constrains().insets = new Insets(2, 6, 10, 12);
	...
	public void fireViewController()
	{
		...
		// =======================================================
		{
			...
			context.getRootPane().getInputMap(JComponent.WHEN_ANCESTOR_OF_FOCUSED_COMPONENT).put(ctrlStroke, "VK_I");
			context.getRootPane().getInputMap(JComponent.WHEN_ANCESTOR_OF_FOCUSED_COMPONENT).put(metaStroke, "VK_I");
			context.getRootPane().getActionMap().put("VK_I", action);
		}
		// -------------------------------------------------------
		{
			...
			context.getRootPane().getInputMap(JComponent.WHEN_ANCESTOR_OF_FOCUSED_COMPONENT).put(ctrlStroke, "VK_R");
			context.getRootPane().getInputMap(JComponent.WHEN_ANCESTOR_OF_FOCUSED_COMPONENT).put(metaStroke, "VK_R");
			context.getRootPane().getActionMap().put("VK_R", action);
		}
		// -------------------------------------------------------
		{
			...
			context.getRootPane().getInputMap(JComponent.WHEN_ANCESTOR_OF_FOCUSED_COMPONENT).put(ctrlStroke, "VK_P");
			context.getRootPane().getInputMap(JComponent.WHEN_ANCESTOR_OF_FOCUSED_COMPONENT).put(metaStroke, "VK_P");
			context.getRootPane().getActionMap().put("VK_P", action);
		}
		// -------------------------------------------------------
		{
			...
			context.getRootPane().getInputMap(JComponent.WHEN_ANCESTOR_OF_FOCUSED_COMPONENT).put(ctrlStroke, "VK_S");
			context.getRootPane().getInputMap(JComponent.WHEN_ANCESTOR_OF_FOCUSED_COMPONENT).put(metaStroke, "VK_S");
			context.getRootPane().getActionMap().put("VK_S", action);
		}
		// -------------------------------------------------------
		{
			...
			context.getRootPane().getInputMap(JComponent.WHEN_ANCESTOR_OF_FOCUSED_COMPONENT).put(ctrlStroke, "VK_D");
			context.getRootPane().getInputMap(JComponent.WHEN_ANCESTOR_OF_FOCUSED_COMPONENT).put(metaStroke, "VK_D");
			context.getRootPane().getActionMap().put("VK_D", action);
		}
	...
	public void updateViewController(TrackerManager tracker)
	{
		// =======================================================
...

		{
			...
			breakTask.getProject().setIdProject(0);
			breakTask.getProject().setDescription("");
			breakTask.getProject().setAnnotation("");
		}
	...
	private class FactoryCellRenderer extends Panel implements TableCellRenderer
	{
		...
		public FactoryCellRenderer()
		{
			...
			setBorder(BorderFactory.createCompoundBorder(borderSuperior, borderDecorator));
			{
				...
				fieldTaskDescription.setForeground(Color.decode("#FFFFFF"));
				fieldTaskDescription.setOpaque(false);
				layout.constrains().weightx = 1.0;
			...
			}
			{
				...
				fieldProjectDescription.setOpaque(false);
				layout.constrains().weightx = 1.0;
			...
			}
			{
				...
				panelSessionInformation.setOpaque(false);
				{
					labelSessionDuration = new Label("--");
					labelSessionDuration.setForeground(Color.decode("#FFFFFF"));
					labelSessionDuration.setOpaque(false);
				...
				}
				{
					...
					labelSessionInitiated.setOpaque(false);
